...
python -m vagen.env.frozen_lake.create_dataset \
    --visual_env \
    --data_dir data/frozen_lake-vision-1-step \
    --max_action_length 1 \
    --size 8 \
    --is_slippery \
    --p 0.8 \
...
python3 -m vagen.trainer.main_ppo \
    ...
    data.train_files=data/frozen_lake-vision-1-step/train.parquet \
    data.val_files=data/frozen_lake-vision-1-step/test.parquet \
